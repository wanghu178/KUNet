...
from skimage.metrics import peak_signal_noise_ratio as ps
ref_dir = r"E:\hdrtv\test_set\test_hdr"
#ref_alignratio_dir = r"E:\NTIRE_single\test\alignratio"

fake_dir = r"D:\experiment\KUnet\img\results\fine_hdrtv_107000\000_Valid_SingleFrame_FirstStage"
...
for filename in sorted(os.listdir(ref_dir)):
    ...
    fake_hdr_image = utils.read_img(env=None,path=osp.join(fake_dir, "{:03d}.png".format(image_id)))
